...
func (ec *executionContext) field_Mutation_createArticle_args(ctx context.Context, rawArgs map[string]interface{}) (map[string]interface{}, error) {
	...
	if tmp, ok := rawArgs["input"]; ok {
		...
		arg0, err = ec.unmarshalNNewArticle2wiremanᚋgraphᚋmodelᚐNewArticle(ctx, tmp)
		if err != nil {
			return nil, err
		}
	}
...
func (ec *executionContext) fieldContext_Article_articleType(_ context.Context, field graphql.CollectedField) (fc *graphql.FieldContext, err error) {
	fc = &graphql.FieldContext{
		...
		IsResolver: false,
		Child: func(ctx context.Context, field graphql.CollectedField) (*graphql.FieldContext, error) {
			return nil, errors.New("field of type ArticleStyle does not have child fields")
		},
	}
	return fc, nil
}
...
func (ec *executionContext) _Mutation_createArticle(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	fc.Result = res
	return ec.marshalNArticle2ᚖwiremanᚋgraphᚋmodelᚐArticle(ctx, field.Selections, res)
}
...
func (ec *executionContext) _Query_articles(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	res := resTmp.([]*model.Article)
	fc.Result = res
	return ec.marshalNArticle2ᚕᚖwiremanᚋgraphᚋmodelᚐArticle(ctx, field.Selections, res)
}
...
func (ec *executionContext) marshalNArticle2wiremanᚋgraphᚋmodelᚐArticle(ctx context.Context, sel ast.SelectionSet, v model.Article) graphql.Marshaler {
	return ec._Article(ctx, sel, &v)
}

func (ec *executionContext) marshalNArticle2ᚕᚖwiremanᚋgraphᚋmodelᚐArticle(ctx context.Context, sel ast.SelectionSet, v []*model.Article) graphql.Marshaler {
	...
	for i := range v {
		...
		f := func(i int) {
			...
			ret[i] = ec.marshalOArticle2ᚖwiremanᚋgraphᚋmodelᚐArticle(ctx, sel, v[i])
		}
		if isLen1 {
			f(i)
		} else {
...
func (ec *executionContext) marshalNArticle2ᚖwiremanᚋgraphᚋmodelᚐArticle(ctx context.Context, sel ast.SelectionSet, v *model.Article) graphql.Marshaler {
	if v == nil {
...
func (ec *executionContext) unmarshalNArticleStyle2wiremanᚋgraphᚋmodelᚐArticleStyle(ctx context.Context, v interface{}) (model.ArticleStyle, error) {
	var res model.ArticleStyle
	err := res.UnmarshalGQL(v)
	return res, graphql.ErrorOnPath(ctx, err)
}

func (ec *executionContext) marshalNArticleStyle2wiremanᚋgraphᚋmodelᚐArticleStyle(ctx context.Context, sel ast.SelectionSet, v model.ArticleStyle) graphql.Marshaler {
	return v
}
...
func (ec *executionContext) unmarshalNNewArticle2wiremanᚋgraphᚋmodelᚐNewArticle(ctx context.Context, v interface{}) (model.NewArticle, error) {
...
func (ec *executionContext) marshalOArticle2ᚖwiremanᚋgraphᚋmodelᚐArticle(ctx context.Context, sel ast.SelectionSet, v *model.Article) graphql.Marshaler {
	if v == nil {
		return graphql.Null
	}
	return ec._Article(ctx, sel, v)
